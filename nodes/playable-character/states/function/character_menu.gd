...
func _on_enter(actor: Node, _blackboard: BTBlackboard) -> void:
	...
	_playable_character_character_stage_instance.current_character_internal_name = character_internal_name
	_playable_character_character_ui_instance.current_character_internal_name = character_internal_name

	_playable_character_character_ui_instance.character_change_requested.connect(_on_character_change_requested)
...
func _on_character_change_requested(internal_name: StringName):
	...
	_playable_character_character_ui_instance.current_character_internal_name = internal_name
