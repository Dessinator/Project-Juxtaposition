...
const HEAVY_ATTACK_TYPE_STRING: StringName = &"heavy_attack"
...
func _on_enter(actor: Node, blackboard: BTBlackboard) -> void:
	...
	var next_attack_internal_name = character_combo.get_next_attack_id(current_attack_internal_name, HEAVY_ATTACK_TYPE_STRING)
