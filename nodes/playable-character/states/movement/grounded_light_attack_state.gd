...
func _handle_attack_chain_start(playable_character: PlayableCharacter, blackboard: BTBlackboard):
	_attack_instance = _playable_character_combat_manager.start_attack(CharacterAttackState.AttackType.TYPE_LIGHT_ATTACK, _animation_state)
...
func _on_pressed_light_attack_input(playable_character: PlayableCharacter, blackboard: BTBlackboard):
...
func _handle_transitions(playable_character: PlayableCharacter, blackboard: BTBlackboard):
