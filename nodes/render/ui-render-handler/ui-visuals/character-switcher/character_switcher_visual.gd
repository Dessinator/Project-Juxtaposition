...
@onready var _character_stamina_bar: CharacterStatusBar = %CharacterStaminaBar
...
func update_character_switch_cooldown_progress(time_left: float, starting_time: float):
	_character_switch_cooldown_texture_progress_bar.max_value = starting_time
	_character_switch_cooldown_texture_progress_bar.value = time_left
...
func update_stamina_bar(current_stamina: int, max_stamina: int):
	_character_stamina_bar.set_current_value(current_stamina)
	_character_stamina_bar.set_max_value(max_stamina)
