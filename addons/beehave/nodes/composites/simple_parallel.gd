...
func tick(actor, blackboard: BHBlackboard):
...
func before_run(actor: Node, blackboard:BHBlackboard) -> void:
	secondary_node_repeat_left = secondary_node_repeat_count
	super(actor, blackboard)

func interrupt(actor: Node, blackboard: BHBlackboard) -> void:
...
func after_run(actor: Node, blackboard: BHBlackboard) -> void:
	_reset()
	super(actor, blackboard)
...
func _cleanup_running_task(finished_action: Node, actor: Node, blackboard: BHBlackboard):
